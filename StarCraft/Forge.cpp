...
HRESULT CForge::Initialize(void)
{
	...
	lstrcpy(m_tInfo.szStateKey, L"Forge");
...
void CForge::Release(void)
{
}

void CForge::CheckOneClick(void)	// 건물을 클릭했을때 우측 아이콘 뜨는 부분
{
	D3DXMATRIX matTrans;
	float fX = 0.f, fY = 0.f;
	...
	{
		if ((*iter)->GetBuildType() == BUILD_CYBERNETICS_CORE && (*iter)->GetBuildCreateType() != BUILD_CREATE_CREATE)
		{
			bCheck1 = true;
		}

		if ((*iter)->GetBuildType() == BUILD_TEMPAR_ARCHIVES && (*iter)->GetBuildCreateType() != BUILD_CREATE_CREATE)
		{
			bCheck2 = true;
		}
	}

	if (0 != D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT) && !bCheck2)
	{
	...
	if (0 != D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR) && !bCheck2)
	{
	...
	if (0 != D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD) && !bCheck1)
	{
	...
	{
		if (3 > D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
		{
			// 1번째 칸
			pInterpacetexture = TextureMgr->GetTexture(L"Button"
				, L"GroundAttUpgrade", m_iClickMyInterpace[0]);
		...
		if (3 > D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
		{

			// 2번째 칸
			pInterpacetexture = TextureMgr->GetTexture(L"Button"
				, L"GroundArmorUpgrade", m_iClickMyInterpace[1]);
		...
		if (3 > D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
		{

			// 3번째 칸
			pInterpacetexture = TextureMgr->GetTexture(L"Button"
				, L"GroundShildUpgrade", m_iClickMyInterpace[2]);
...
void CForge::Function(void)
{
	...
	if (m_eBuildCreateType != BUILD_CREATE_NOMAL)
	{
		if (dwKey & KEY_LBUTTON && D_CAST(CInterpace, pInterpace)->CheckingPointInRect(vMouse, 8) && !m_bKeyInput)
		{
			...
			{
				if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 100);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 100);
				}
				else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 150);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 150);
				}
				else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
				{
			...
			{
				if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 100);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 100);
				}
				else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 175);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 175);
				}
				else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
				{
			...
			{
				if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 200);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 200);
				}
				else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 300);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 300);
				}
				else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
				{
					D_CAST(CInterpace, pInterpace)->PlusWorldMineral(m_eTeamType, 400);
					D_CAST(CInterpace, pInterpace)->PlusWorldGas(m_eTeamType, 400);
				}
			}
...
void CForge::CreateUnit(bool Check)	// 생산중일때 Check false 에서 중앙 인터페이스 뜨는 부분
{
		...
		else
		{
			...
			if (m_tCreateTime.fFrame > m_tCreateTime.fMax)
			{
				...
				if (!lstrcmp(m_szKey, L"W"))
				{
					if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT, 1);
					}
					else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT, 2);
					}
					else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ATT, 3);
					}
				}
				else if (!lstrcmp(m_szKey, L"A"))
				{
					if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR, 1);
					}
					else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR, 2);
					}
					else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_GROUND_ARMOR, 3);
					}
				}
				else if (!lstrcmp(m_szKey, L"S"))
				{
					if (0 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_SHILD, 1);
					}
					else if (1 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_SHILD, 2);
					}
					else if (2 == D_CAST(CInterpace, pInterpace)->GetUpgradeCount(m_eTeamType, UPGRADE_SHILD))
					{
						D_CAST(CInterpace, pInterpace)->SetUpgradeCount(m_eTeamType, UPGRADE_SHILD, 3);
					}
				}
