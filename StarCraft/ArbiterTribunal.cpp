...
HRESULT CArbiterTribunal::Initialize(void)
{
	...
	lstrcpy(m_tInfo.szStateKey, L"ArbiterTribunal");
...
int CArbiterTribunal::Update(void)
{
...
void CArbiterTribunal::Render(void)
{
...
void CArbiterTribunal::Release(void)
{
}

void CArbiterTribunal::Function(void)
{

}

void CArbiterTribunal::CheckOneClick(void)
{
	D3DXMATRIX matTrans;
	float fX = 0.f, fY = 0.f;
	...
	else
	{
		// 1번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"Recall", m_iClickMyInterpace[0]);
		...
		// 2번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"StasisField", m_iClickMyInterpace[1]);
		...
		// 3번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"ArbiterMpUpgrade", m_iClickMyInterpace[2]);
...
void CArbiterTribunal::CreateUnit(bool Check)
{
...
void CArbiterTribunal::SettingTile(void)
{
