...
HRESULT CFleetBeacon::Initialize(void)
{
	...
	lstrcpy(m_tInfo.szStateKey, L"FleetBeacon");
...
void CFleetBeacon::Release(void)
{
}

void CFleetBeacon::Function(void)
{
}

void CFleetBeacon::CheckOneClick(void)
{
	D3DXMATRIX matTrans;
	float fX = 0.f, fY = 0.f;
	...
	else
	{
		// 1번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"ScoutViewUpgrade", m_iClickMyInterpace[0]);
		...
		// 2번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"ScoutSpeedUpgrade", m_iClickMyInterpace[1]);
		...
		// 3번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"InterceptorCountUpgrade", m_iClickMyInterpace[2]);
		...
		// 5번째 칸
		pInterpacetexture = TextureMgr->GetTexture(L"Button"
			, L"CorsairMpUp", m_iClickMyInterpace[4]);
...
void CFleetBeacon::CreateUnit(bool Check)
{
...
void CFleetBeacon::SettingTile(void)
{
